...
struct DirectControlFlowInfo {
  ...
  // An unbounded register-target transfer may enter any instruction. This is
  // tracked separately from unresolved calls so ordinary function-local
  // patching remains available while synthetic source-tail ranges fail closed.
